...
echo ""
echo "🎯 Next steps:"
echo "  1. Add your OpenAI API key to .env for vector search"
echo "  2. Run 'npm run dev' to start the server"
echo "  - Visit http://localhost:3001 and click 'Generate All Embeddings'"
echo "  3. Run 'npm run dev:client' to start the UI"
